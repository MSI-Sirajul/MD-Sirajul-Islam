...
const RotatingSlogan: React.FC<RotatingSloganProps> = ({ 
  ...
  return (
    <div className="h-6 relative overflow-hidden">
      <span 
        className={`absolute left-0 top-0 text-sm font-light tracking-wide transition-all duration-250 bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent
